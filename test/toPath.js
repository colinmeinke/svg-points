...
test('should return correct path from circle points', () => {
  const points = [
...
test('should return correct path from ellipse points', () => {
  const points = [
...
test('should return correct path from line points', () => {
  const points = [
...
test('should return correct path from path points', () => {
  const points = [
...
test('should return correct path from path points (with moveto)', () => {
  const points = [
    { x: 20, y: 20, moveTo: true },
    { x: 20, y: 50 },
...
test('should return correct path from path points (with arcs)', () => {
  const points = [
    { x: 20, y: 20, moveTo: true },
    { x: 70, y: 20 },
    { x: 70, y: 40 },
...
test('should return correct path from path points (with cubic beziers)', () => {
  const points = [
    { x: 20, y: 20, moveTo: true },
    { x: 70, y: 20 },
    { x: 70, y: 40 },
...
test('should return correct path from path points (with shorthand cubic beziers)', () => {
  const points = [
...
test('should return correct path from path points (with quadratic beziers)', () => {
  const points = [
    { x: 20, y: 20, moveTo: true },
    { x: 70, y: 20 },
    { x: 70, y: 40 },
...
test('should return correct path from path points (with shorthand quadratic beziers)', () => {
  const points = [
...
test('should return correct path from path points (with moveTo last point)', () => {
  const points = [
...
test('should return correct path from polyline points', () => {
  const points = [
...
test('should return correct path from polygon points', () => {
  const points = [
    { x: 20, y: 30, moveTo: true },
    { x: 50, y: 90 },
    { x: 20, y: 90 },
...
test('should return correct path from rect points', () => {
  const points = [
...
test('should return correct path from rect points (with corner radius)', () => {
  const points = [
...
test('should return correct path from circle shape', () => {
...
test('should return correct paths from g shape', () => {
  const shape = {
    type: 'g',
    shapes: [
...
test('should return correct paths from a group of points', () => {
  const points = [
    [
      { x: 50, y: 30, moveTo: true },
